...
object ControlPacketV5Factory : ControlPacketFactory {
    ...
    override fun subscribe(
        ...
        val props = SubscribeRequest.VariableHeader.Properties(
            reasonString = "",
    ...
    override suspend fun defaultPersistence(androidContext: Any?, name: String, inMemory: Boolean): Persistence =
        newDefaultPersistence(androidContext, name, inMemory)
}
