 ...
 *  - multi-param parent threading `ControlPacketV5<W : Payload, PWD : Payload, P : Payload>`
 ...
 *  - a hand-written `ConnectCodec` per variant.
 *
 * Until then PUBLISH payloads + Will payloads are intermediated through this type, which
 * is **non-spec-compliant**: MQTT v5 §3.3.2 (PUBLISH application bytes) and §3.1.3.3
