...
// hand-written legacy classes (PingRequest, PublishAcknowledgment, etc.). `V5Packet` extends
...
//
// The processor processes only this `V5Packet` declaration (the parent `ControlPacketV5`
...
@ProtocolMessage
sealed interface V5Packet : ControlPacketV5 {
    ...
    data class Connect<@Payload WP>(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) {
            // V5PacketConnectCodec.encode is generic; production always uses ReadBuffer payloads.
            @Suppress("UNCHECKED_CAST")
            V5PacketConnectCodec.encode(writeBuffer, this as Connect<ReadBuffer?>) { buf, wp ->
    ...
    data class ConnAck(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketConnAckCodec.encode(writeBuffer, this)
    ...
    data class PubAck(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketPubAckCodec.encode(writeBuffer, this)
    ...
    data class PubRec(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketPubRecCodec.encode(writeBuffer, this)
    ...
    data class PubRel(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketPubRelCodec.encode(writeBuffer, this)
    ...
    data class PubComp(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketPubCompCodec.encode(writeBuffer, this)
    ...
    data class Disconnect(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketDisconnectCodec.encode(writeBuffer, this)
    ...
    data class Auth(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketAuthCodec.encode(writeBuffer, this)
    ...
    data class Subscribe(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketSubscribeCodec.encode(writeBuffer, this)
    ...
    data class SubAck(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketSubAckCodec.encode(writeBuffer, this)
    ...
    data class Unsubscribe(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketUnsubscribeCodec.encode(writeBuffer, this)
    ...
    data class UnsubAck(
        ...
        override fun encodeBody(writeBuffer: WriteBuffer) =
            V5PacketUnsubAckCodec.encode(writeBuffer, this)
...
typealias PingRequest = V5Packet.PingReq
typealias PingResponse = V5Packet.PingResp
typealias PublishAcknowledgment = V5Packet.PubAck
typealias PublishReceived = V5Packet.PubRec
typealias PublishRelease = V5Packet.PubRel
typealias PublishComplete = V5Packet.PubComp
typealias DisconnectNotification = V5Packet.Disconnect
typealias AuthenticationExchange = V5Packet.Auth
typealias ConnectionAcknowledgment = V5Packet.ConnAck
typealias ConnectionRequest = V5Packet.Connect<ReadBuffer?>
...
fun ConnectionRequest(
    ...
    willProperties: ConnectWillProperties? =
        if (will is WillConfig.Enabled) ConnectWillProperties() else null,
): ConnectionRequest = V5Packet.Connect.create(
    clientId, keepAliveSeconds, cleanStart, userName, password, will,
    protocolName, protocolVersion, props, willProperties,
)
typealias SubscribeRequest = V5Packet.Subscribe
typealias SubscribeAcknowledgement = V5Packet.SubAck
typealias UnsubscribeRequest = V5Packet.Unsubscribe
typealias UnsubscribeAcknowledgment = V5Packet.UnsubAck
