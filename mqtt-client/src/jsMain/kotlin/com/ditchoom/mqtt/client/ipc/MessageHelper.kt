...
internal const val MESSAGE_PACKET_ID_KEY = "mqtt-packet-id-key"
...
fun buildOutgoingControlPacketMessage(jsBuffer: JsBuffer): dynamic {
    val obj = js("({})")
    obj[MESSAGE_TYPE_KEY] = MESSAGE_TYPE_CONTROL_PACKET
    obj[MESSAGE_INCOMING_KEY] = false
...
fun writeBufferInMessage(
    ...
    if (jsBuffer != null) {
        ...
        obj[MESSAGE_BUFFER_KEY] = jsBuffer.buffer.buffer
    }
}
